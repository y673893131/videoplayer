...
//        int count = 0;
//        for(auto& it : m_dy.nameToClass)
//        {
//            qDebug() << "class-------->" <<it.names;
//            for(int n = 0 ; n < it.names.size(); ++n)
//            {
//                qDebug() << it.names[n] << it.urls[n];
//                ++count;
//            }
